package com.iot.Netty博客学习.AttributeMap;
...
import static com.iot.Netty博客学习.AttributeMap.AttributeMapConstant.NETTY_CHANNEL_KEY;
...
//		Attribute<NettyChannel> attr = ctx.channel().attr(NETTY_CHANNEL_KEY);
		...
		if (nChannel == null) {
			...
			System.out.println("handler1 注入");
		} else {
